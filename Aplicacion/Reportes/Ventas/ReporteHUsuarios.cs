...
namespace Aplicacion.Reportes.Ventas
{
    public class ReporteHUsuarios
    {
        ...
        public class Manejador: IRequestHandler<Consulta, Stream>
        {
            ...
            {
                var usuario = await context.InformacionUsuarioFacturas.ToListAsync();
                ...
                document.Open();
                document.AddTitle("Historial de Usuarios");
            ...
            // CELDA IZQUIERDA
                ...
                PdfPCell twocell = new PdfPCell(new Phrase("Historial de Facturaciones de Usuarios", fuenteTitulo2));
            ...
            // CUERPO
                ...
                float[] width = new float[]{12, 12, 12, 12, 14, 11, 11, 12};
                ...
                PdfPCell celdaColor = new PdfPCell(new Phrase("Email", fuenteEncabezado));
                ...
                PdfPCell celdaTalla = new PdfPCell(new Phrase("Tipo Usuario", fuenteEncabezado));
                ...
                PdfPCell celdaDisti = new PdfPCell(new Phrase("Estado", fuenteEncabezado));
                ...
                PdfPCell celdaPrecioV = new PdfPCell(new Phrase("N° Factura", fuenteEncabezado));
                ...
                PdfPCell celdaStock = new PdfPCell(new Phrase("Fecha", fuenteEncabezado));
                ...
                {
                    PdfPCell celdaDatoCod = new PdfPCell(new Phrase("" + usu.Cedula, fuenteDatos));
                    ...
                    PdfPCell celdaDatoCat = new PdfPCell(new Phrase("" + usu.NombrePersona, fuenteDatos));
                    ...
                    PdfPCell celdaDatoMarc = new PdfPCell(new Phrase("" + usu.ApellidoPersona, fuenteDatos));
                    ...
                    PdfPCell celdaDatoColor = new PdfPCell(new Phrase("" + usu.Email, fuenteDatos));
                    ...
                    PdfPCell celdaDatoTalla = new PdfPCell(new Phrase(usu.TipoUsuario.ToString(), fuenteDatos));
                    ...
                    PdfPCell celdaDatoDist = new PdfPCell(new Phrase("" + usu.Estado, fuenteDatos));
                    ...
                    PdfPCell celdaDatoPreV = new PdfPCell(new Phrase("" + usu.IdFactura, fuenteDatos));
                    ...
                    PdfPCell celdaDatoStock = new PdfPCell(new Phrase("" + usu.FechaFactura, fuenteDatos));
