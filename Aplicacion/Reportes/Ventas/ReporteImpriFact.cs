...
namespace Aplicacion.Reportes
{
    public class ReporteImpriFact
    {
        ...
        public class Manejador: IRequestHandler<Consult, Stream>
        {
            ...
            {
                int id = request.IdFactura;

                var facturacion = await context.ImprimirFacturaVentas.Where(facturacio => facturacio.IdFactura == id).ToListAsync();
                //var facturacion = await context.ImprimirFacturaVentas.ToListAsync();
                var datosFactura = context.ImprimirFacturaVentas.FirstOrDefault(facturacio => facturacio.IdFactura == id);
                ...
                document.Open();
                document.AddTitle("Impresión de Factura");
            ...
            // CELDA IZQUIERDA
                ...
                PdfPCell twocell = new PdfPCell(new Phrase("Factura de Ventas", fuenteTitulo2));
                ...
                intertableiz.SetTotalWidth(new float[] { 30, 70 });                 
                intertableiz.DefaultCell.Border = Rectangle.NO_BORDER;

                PdfPCell CeldaFactura = new PdfPCell(new Phrase("Venta Nº:", fuenteTitulo3));
                ...
                intertableiz.AddCell(new Phrase(datosFactura.IdFactura.ToString(), fuenteTitulo3));
            ...
            // CUERPO
                ...
                PdfPCell CeldaProve = new PdfPCell(new Phrase("Cliente:", fuenteDatos2));
                CeldaProve.HorizontalAlignment = 50;
                CeldaProve.Border = Rectangle.NO_BORDER;
                celda2.AddCell(CeldaProve);
                celda2.AddCell(new Phrase(datosFactura.NombrePersona + " " + datosFactura.ApellidoPersona, fuenteDatos));
                celda2.AddCell("");
                celda2.AddCell("");
                ...
                celda2.AddCell(new Phrase(datosFactura.DireccionCliente.ToString(), fuenteDatos));
                ...
                celda3.AddCell(new Phrase(datosFactura.FechaFactura.ToString(), fuenteDatos));
                celda3.AddCell("");
                celda3.AddCell("");
                ...
                celda3.AddCell(new Phrase(datosFactura.NumCliente.ToString(), fuenteDatos));
                ...
                foreach(var f in facturacion)
                {
                    ...
                    PdfPCell celdaDatoColor = new PdfPCell(new Phrase("" + f.CantidadProductosF, fuenteDatos));
                    ...
                    PdfPCell celdaDatoID = new PdfPCell(new Phrase("C$ " + f.PrecioVenta, fuenteDatos));
                ...
                PdfPCell celdaDatoTotal = new PdfPCell(new Phrase("C$ " + datosFactura.TotaFactura.ToString(), fuenteDatos));
