...
{
    public class ReporteAllFacturacion
    {
        ...
        public class Manejador: IRequestHandler<Consulta, Stream>
        {
            ...
            public async Task<Stream> Handle(Consulta request, CancellationToken cancellationToken)
            {
                var facturacion = await context.TodasFacturasVentas.ToListAsync();
            ...
            // CELDA IZQUIERDA
                ...
                PdfPCell twocell = new PdfPCell(new Phrase("Reporte de Facturas", fuenteTitulo2));
            ...
            // CUERPO
                ...
                foreach(var colorr in facturacion)
                {
                    PdfPCell celdaDatoID = new PdfPCell(new Phrase("" + colorr.IdFactura, fuenteDatos));
                    ...
                    PdfPCell celdaDatoColor = new PdfPCell(new Phrase("" + colorr.FechaFactura, fuenteDatos));
