...
namespace Aplicacion.Reportes.Ventas
{
    public class ReporteHCliente
    {
        ...
        public class Manejador: IRequestHandler<Consulta, Stream>
        {
            ...
            {
                var cliente = await context.InformacionClienteFacturas.ToListAsync();
                ...
                document.Open();
                document.AddTitle("Historial de Clientes");
            ...
            // CELDA IZQUIERDA
                ...
                PdfPCell twocell = new PdfPCell(new Phrase("Historial de Facturaciones a Cliente", fuenteTitulo2));
            ...
            // CUERPO
                ...
                float[] width = new float[]{12, 12, 12, 12, 12, 12, 12, 12};
                tablaDatos.SpacingBefore = 60;
                tablaDatos.SetWidthPercentage(width, rectangle);

                PdfPCell celdaCod = new PdfPCell(new Phrase("Cédula", fuenteEncabezado));
                ...
                PdfPCell celdaCateg = new PdfPCell(new Phrase("Nombre", fuenteEncabezado));
                ...
                PdfPCell celdaMarca = new PdfPCell(new Phrase("Apellido", fuenteEncabezado));
                ...
                PdfPCell celdaColor = new PdfPCell(new Phrase("Dirección", fuenteEncabezado));
                ...
                PdfPCell celdaTalla = new PdfPCell(new Phrase("Número", fuenteEncabezado));
                ...
                PdfPCell celdaDisti = new PdfPCell(new Phrase("N° Factura", fuenteEncabezado));
                ...
                PdfPCell celdaPrecioV = new PdfPCell(new Phrase("Fecha", fuenteEncabezado));
                ...
                PdfPCell celdaStock = new PdfPCell(new Phrase("Descuento", fuenteEncabezado));
                ...
                foreach(var stock in cliente)
                {
                    PdfPCell celdaDatoCod = new PdfPCell(new Phrase("" + stock.Cedula, fuenteDatos));
                    ...
                    PdfPCell celdaDatoCat = new PdfPCell(new Phrase("" + stock.NombrePersona, fuenteDatos));
                    ...
                    PdfPCell celdaDatoMarc = new PdfPCell(new Phrase("" + stock.ApellidoPersona, fuenteDatos));
                    ...
                    PdfPCell celdaDatoColor = new PdfPCell(new Phrase("" + stock.DireccionCliente, fuenteDatos));
                    ...
                    PdfPCell celdaDatoTalla = new PdfPCell(new Phrase(stock.NumCliente.ToString(), fuenteDatos));
                    ...
                    PdfPCell celdaDatoDist = new PdfPCell(new Phrase("" + stock.IdFactura, fuenteDatos));
                    ...
                    PdfPCell celdaDatoPreV = new PdfPCell(new Phrase("" + stock.FechaFactura, fuenteDatos));
                    ...
                    PdfPCell celdaDatoStock = new PdfPCell(new Phrase("C$ " + stock.DescuentoFactura, fuenteDatos));
