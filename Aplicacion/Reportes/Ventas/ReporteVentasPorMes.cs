    ...
    public class ReporteVentasPorMes
    {
        ...
        public class Manejador: IRequestHandler<Consulta, Stream>
        {
            ...
            public async Task<Stream> Handle(Consulta request, CancellationToken cancellationToken)
            {
                ...
                var ventas = await context.VentasMes.ToListAsync();
                ...
                document.Open();
                document.AddTitle("Ventas por Mes");
            ...
            // CELDA IZQUIERDA
                ...
                PdfPCell twocell = new PdfPCell(new Phrase("Reporte Ventas por Mes", fuenteTitulo2));
            ...
            // CUERPO
                ...
                PdfPCell celdaID = new PdfPCell(new Phrase("Mes", fuenteEncabezado));
                ...
                {
                    PdfPCell celdaDatoID = new PdfPCell(new Phrase("" + vent.Mes, fuenteDatos));
                    ...
                    PdfPCell celdaDatoColor = new PdfPCell(new Phrase("C$ " + vent.Subtotal, fuenteDatos));
