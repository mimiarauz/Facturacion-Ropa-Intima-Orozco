...
{
    public class ReporteVentasPorAño
    {
        ...
        public class Manejador: IRequestHandler<Consulta, Stream>
        {
            ...
            public async Task<Stream> Handle(Consulta request, CancellationToken cancellationToken)
            {
                ...
                var ventas = await context.VentasAños.ToListAsync();
                ...
                document.Open();
                document.AddTitle("Ventas por Año");
            ...
            // CELDA IZQUIERDA
                ...
                PdfPCell twocell = new PdfPCell(new Phrase("Reporte Ventas por Año", fuenteTitulo2));
            ...
            // CUERPO
                ...
                {
                    PdfPCell celdaDatoID = new PdfPCell(new Phrase("" + vent.Año, fuenteDatos));
