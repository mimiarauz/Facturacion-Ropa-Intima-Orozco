...
{
    public class ReporteComprasPorMes
    {
        ...
        public class Manejador: IRequestHandler<Consulta, Stream>
        {
            ...
            {
                var compra = await context.ComprasMes.ToListAsync();
                ...
                document.Open();
                document.AddTitle("Compras por Mes");
            ...
            // CELDA IZQUIERDA
                ...
                PdfPCell twocell = new PdfPCell(new Phrase("Reporte Compras por Mes", fuenteTitulo2));
            ...
            // CUERPO
                ...
                foreach(var compr in compra)
                {
                    PdfPCell celdaDatoID = new PdfPCell(new Phrase("" + compr.Mes, fuenteDatos));
