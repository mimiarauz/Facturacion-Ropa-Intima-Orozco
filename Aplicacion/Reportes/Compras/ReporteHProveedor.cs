...
// {
//     public class ReporteHProveedor
//     {
...
//             {
//                 var Hproveedor = await context.InformacionProveedorCompras.ToListAsync();
...
//                 PdfPCell twocell = new PdfPCell(new Phrase("Historial de Compras", fuenteTitulo2));
...
//                     PdfPCell celdaDatoPreV = new PdfPCell(new Phrase("" + stock.PrecioVenta, fuenteDatos));
