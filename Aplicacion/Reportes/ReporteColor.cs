    ...
    public class ReporteColor
    {
        ...
        public class Manejador: IRequestHandler<Consulta, Stream>
        {
            ...
            public async Task<Stream> Handle(Consulta request, CancellationToken cancellationToken)
            {
                ...
                var color = await context.Colors.ToListAsync();
            ...
            // CELDA IZQUIERDA
                ...
                PdfPCell twocell = new PdfPCell(new Phrase("Reporte de colores", fuenteTitulo2));
            ...
            // CUERPO
                ...
                PdfPCell celdaID = new PdfPCell(new Phrase("Id", fuenteEncabezado));
                ...
                foreach(var colorr in color)
                {
                    PdfPCell celdaDatoID = new PdfPCell(new Phrase("" + colorr.IdColor, fuenteDatos));
                    ...
                    PdfPCell celdaDatoColor = new PdfPCell(new Phrase("" + colorr.Color1, fuenteDatos));
...
//                 centro.AddCell(noCell);
// PdfPCell noCell2 = new PdfPCell(new Phrase("fsdfdss :", fuenteEncabezado));
//                 // noCell2.HorizontalAlignment = 2;
//                 noCell2.Border = Rectangle.NO_BORDER;
//                 centro.AddCell(noCell2);
